...
class ofdm_cube(grc_wxgui.top_block_gui):

	def __init__(self):
		grc_wxgui.top_block_gui.__init__(self, title="Ofdm Cube")
		...
		self.ofdm_cube_ff_0 = ofdm.ofdm_swig.cube_ff()
		...
		self.connect((self.thr, 0), (self.ofdm_cube_ff_0, 0))
		self.connect((self.ofdm_cube_ff_0, 0), (self.sink2, 0))
